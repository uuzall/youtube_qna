...
I have included some test outputs in this [file](output/answers.txt). You can check them out. Do note that the first few answers hallucinate some new information but it seems that is only because my prompt was not good enough, and my temperature was too high. 
